...
public class Exam09 {
  ...
  public static void main(String[] args) {
    ...
    // 이유: result 변수를 공유하기 때문이다.
    // 해결책: 계산1과 계산2에 대해 result 변수를 개별적으로 관리 해야한다.
    //       =>Calculator2 클래스를 봐
    Calculator.plus(2);
    Calculator.plus(5);
    ...
    // 계산1을 위한 메모리 준비
    // new 명령의 의미?
      // => Calculator2에 선언된 변수 중에서 개별적으로 관리되어야 할 변수(static)이 붙지 않은 변
  ...
  //Calculator3 사용
    ...
    // -> 인스턴스 메서드 
    calc3.plus(2); // 변수.function이 있을때는 function의 this에 자동 저장됨.
    calc4.plus(5);
